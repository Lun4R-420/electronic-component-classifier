...
- Model: YOLO11s (Ultralytics), exported to ONNX for CPU inference
- Backend: FastAPI + Uvicorn
- Frontend: React + TypeScript (Vite)
- Deployment: Docker, multi-stage build, hosted on Render
...
**Overfitting check**: val losses bottomed out around epoch 10 and crept up afterward, but val precision/recall/mAP stayed stable through the same period — the best checkpoint (picked by mAP50-95) wasn't affected.
